    ...
    <div className="max-w-[1240px] p-2 mx-auto my-10 h-[200px] md:grid grid-cols-2">
      ...
      <div className=" col-span-1 flex flex-col justify-center">
        ...
        <p className="my-2 text-justify">
          ...
          alias minima libero delectus eum numquam sed deserunt modi, explicabo
          assumenda consequuntur incidunt placeat nesciunt. Eligendi, aliquam!
          Facere quae, velit ut doloribus nulla doloremque, ex odio, deleniti
          rerum ipsa porro. Veritatis.
        </p>
